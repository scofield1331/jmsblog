...
<div class="post {if isset($type)}{$type|escape:'htmlall':'UTF-8'}-post{/if}">
    <a href="{jmsblog::getPageLink('jmsblog-post', $postparams)|escape:'UTF-8'}" class="thumb">
       <img src="{$image_baseurl|escape:'htmlall':'UTF-8'}{$post['image']|escape:'htmlall'}" alt="{$headingPosts[0]['title']|escape:'htmlall'}">
    </a>
    <div class="info-container">
        <div class="meta-align">
            <div class="big-grid-meta">
                ...
                <a href="{jmsblog::getPageLink('jmsblog-post', $postparams)|escape:'UTF-8'}" class="entry-title">{$post['title']|escape:'htmlall':'UTF-8'}</a>
            </div>
            <div class="bottom-grid-meta">
